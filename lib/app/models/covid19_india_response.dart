...
Covid19IndiaResponse covid19IndiaResponseFromJson(str) =>
    Covid19IndiaResponse.fromJson(json.decode(str));

String covid19IndiaResponseToJson(Covid19IndiaResponse data) =>
    json.encode(data.toJson());

class Covid19IndiaResponse {
  Covid19IndiaResponse({
    this.casesTimeSeries = const [],
    this.statewise = const [],
    this.tested = const [],
  });
  ...
  factory Covid19IndiaResponse.fromJson(Map<String, dynamic> json) =>
      Covid19IndiaResponse(
...
class CasesTimeSeries {
  ...
  factory CasesTimeSeries.fromJson(Map<String, dynamic> json) =>
      CasesTimeSeries(
        ...
        date: json["date"],
        dateymd:
            json["dateymd"] == null ? null : DateTime.parse(json["dateymd"]),
